...
struct FinalGradeReviewView: View {
    ...
    var body: some View {
        ...
        .confirmationDialog(
            ...
            Text("Approve this as the final grade? MarkForMe will keep the unreviewed suggestion in teacher-only review history, and the final score and feedback will reflect your reviewed edits.")
        }
    }
