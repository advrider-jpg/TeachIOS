...
## Third-party SDKs
Runtime packages are GRDB.swift, swift-markdown, TPPDF, ZIPFoundation, SwiftCSV, and swift-dependencies. swift-snapshot-testing is test-only. No package introduces runtime network calls, telemetry, accounts, analytics, or cloud services in GradeDraft’s app path.
